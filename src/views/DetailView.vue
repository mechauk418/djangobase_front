  ...
  methods: {
    ...
    create_comment() {
      if (this.login_user==null) {
        ...
        testaxios.post('https://api.isdfans.site/article/' + `${this.$route.params.pk}/comment/`, comment_data,
    ...
    commentDelete(pk) {
      testaxios.delete('https://api.isdfans.site/article/' + `${this.$route.params.pk}/comment/${pk}`,
    ...
    commentLike(pk) {
      if (this.login_user==null){
        ...
        testaxios.post('https://api.isdfans.site/article/' + `${this.$route.params.pk}/comment/${pk}`+'/like/',
        {headers:{Authorization: 'Bearer ' + localStorage.getItem('access_token')} ,withCredentials: true} )
          .then((response) => {
    ...
    like_article(){
      if (this.login_user==null){
        ...
        testaxios.post('https://api.isdfans.site/article/' + `${this.$route.params.pk}/like/`,
        {headers:{Authorization: 'Bearer ' + localStorage.getItem('access_token')}})
        .then((response) => {
          if (response.data.response=='이미 추천하셨습니다.') {
            alert('이미 추천하셨습니다.')
