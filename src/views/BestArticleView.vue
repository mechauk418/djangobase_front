...
export default {
  ...
  mounted() {
    ...
    if (test_page==null){
      testaxios.get('http://localhost:8000/api/article/bestarticle/')
      .then(response => {
      ...
      testaxios.get('http://localhost:8000/api/article/bestarticle/'+'?page='+test_page)
      .then(response => {
        this.articles = response.data.results
        this.current_page = response.data.curPage
        this.total_pages = response.data.itemcount
  ...
  methods:{
    page_change(val){
      ...
      if (this.current_page==1) {
        ...
        testaxios.get('http://localhost:8000/api/article/bestarticle/' + '?page='+this.current_page)
        .then(response => {
          this.articles = response.data.results
          this.current_page = response.data.curPage
          this.total_pages = response.data.itemcount
